...
${videos.map(video2 => `**${++index} -** ${video2.title} **-** ${video2.durationSeconds} Seconds`.replace("&#39;", "'").replace('&quot;', '"').replace("&#39;", "'").replace('&quot;', '"').replace("&#39;", "'").replace('&quot;', '"').replace("&#39;", "'").replace('&quot;', '"').replace("&#39;", "'").replace('&quot;', '"').replace("&#39;", "'").replace('&quot;', '"')).join('\n')}        
