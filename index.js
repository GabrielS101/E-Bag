    ...
    switch(args[0]){
        case 'PurpleHazeDistortion':
         ...
         case 'Whitesnake':  
            ...
            .addImage("https://vignette.wikia.nocookie.net/jjba/images/d/dc/Howaitosuneiku.png/revision/latest?cb=20190829041008")
            .setColor(0xb5b3b3)
         ...
         case 'C-Moon':  
            ...
            .addImage("https://i.pinimg.com/originals/81/c8/f0/81c8f0bdef87eca7b4ab28267e2762f7.png")
            .setColor(0x34a857)
